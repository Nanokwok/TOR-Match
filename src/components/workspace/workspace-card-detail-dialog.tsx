...
function WorkspaceCardDetailBody({
  ...
  return (
    <DialogContent
      ...
      className="max-h-[90vh] w-[calc(100%-2rem)] max-w-2xl overflow-hidden rounded-2xl border border-border bg-white p-0 sm:max-w-2xl"
    >
      <div className="border-b border-border px-6 pb-0 pt-6">
        ...
        <Tabs defaultValue="details" className="mt-5 gap-0">
            ...
            <TabsContent value="details" className="max-h-[52vh] overflow-y-auto px-0 py-5">
              <div className="grid gap-5 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger id="workspace-priority" className="h-10 w-full">
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
                ...
                <div className="space-y-2">
                  ...
                  <Select
                    value={draft.column}
                    onValueChange={(value) => {
                      if (value) patchDraft({ column: value as WorkspaceColumnId })
                    }}
                  >
